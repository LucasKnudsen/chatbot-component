...
export type KnowledgeInputOptionProps = {
  title: string
  description: string
  flow: ActiveFlow
  Icon: any
...
export const KnowledgeInputOption = (
  props: KnowledgeInputOptionProps & { onClick: (args: any) => void }
) => {
  return (
    <div
      ...
      class={`flex transition-all group cursor-pointer lg:flex-col rounded-2xl lg:justify-center items-center lg:items-start  border border-[var(--borderColor)] hover:border-[var(--primaryColor)]
              p-8 hover:bg-[var(--surfaceSoftBackground)] lg:h-96 gap-4 lg:gap-8 w-full lg:w-[272px] lg:min-w-[272px] `}
    >
