...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, isMock, input_1, isAuthorized, _b, _c, newDocument, _d, error_1;
        ...
        switch (_e.label) {
            ...
            case 3: return [4 /*yield*/, (0, authorizers_1.authorizeToken)(event.request.headers.authorization, function (identity) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, authorizeAccess(identity, input_1.data.channelId, true)];
            ...
            case 5:
                ...
                return [4 /*yield*/, createChannelDocument(input_1.data)];
            case 6:
                newDocument = _e.sent();
            ...
            case 8: return [4 /*yield*/, (0, authorizers_1.authorizeToken)(event.request.headers.authorization, function (identity) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, authorizeAccess(identity, input_1.data.channelId)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); })];
...
var authorizeAccess = function (identity, channelId, authorizeWrite) { return __awaiter(void 0, void 0, void 0, function () {
    var params, Item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var createChannelDocument = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var Item, params;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var listChannelDocuments = function (channelId) { return __awaiter(void 0, void 0, void 0, function () {
    var params, Items;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
