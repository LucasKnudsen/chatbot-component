    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, authorizer_1.authorize)(event.headers.Authorization, {
        ...
        case 12:
          ...
          responseStatus =
            ((_b = error_1.response) === null || _b === void 0 ? void 0 : _b.status) || 500
          responseBody = {
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            cognitoClient.send(
              new client_cognito_identity_provider_1.AdminCreateUserCommand({
