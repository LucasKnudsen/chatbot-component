...
var crypto = require('@aws-crypto/sha256-js');
...
var graphqlMutation = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var endpoint, signer, requestToBeSigned, signed, request;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                signed = _a.sent();
                request = new node_fetch_1.Request(endpoint, signed);
